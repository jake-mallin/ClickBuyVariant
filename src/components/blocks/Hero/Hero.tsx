        ...
        <div className="heroCta relative w-full min-w-[400px] sm:w-1/2 self-stretch flex flex-col items-center justify-center bg-[#1AB1F5] rounded-[32px] sm:rounded-bl-[120px] sm:rounded-[0px] p-10 sm:p-12 text-center sm:before:absolute sm:before:bottom-[100%] sm:before:left-0 sm:before:h-[80px] sm:before:w-[9999px] sm:before:bg-[#1AB1F5] sm:after:absolute sm:after:top-0 sm:after:left-[100%] sm:after:h-full sm:after:w-[9999px] sm:after:bg-[#1AB1F5]">
          ...
          <div className="w-full px-6">
            <form className="flex flex-col justify-center items-center gap-4 w-full">
              <input type="text" placeholder="Enter Reg" className="bg-white rounded-lg py-4 px-4 w-full min-w-[180px] max-w-[260px] text-3xl text-[#23323C] uppercase font-bold placeholder-[#23323C] shadow-md text-center" />
